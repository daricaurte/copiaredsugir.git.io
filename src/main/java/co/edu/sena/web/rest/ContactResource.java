...
/**
 * REST controller for managing {@link co.edu.sena.domain.Contact}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ContactResource {
    ...
    public ResponseEntity<Contact> partialUpdateContact(
        ...
        Optional<Contact> result = contactRepository
            ...
            .map(existingContact -> {
                if (contact.getContact3rdSectorHl() != null) {
                    existingContact.setContact3rdSectorHl(contact.getContact3rdSectorHl());
                }
                if (contact.getContactAcademyHl() != null) {
                    existingContact.setContactAcademyHl(contact.getContactAcademyHl());
                }
                if (contact.getContactTeethHl() != null) {
                    existingContact.setContactTeethHl(contact.getContactTeethHl());
                }
                if (contact.getContactEmployeeHl() != null) {
                    existingContact.setContactEmployeeHl(contact.getContactEmployeeHl());
                }
                if (contact.getContactEntFinanHl() != null) {
                    existingContact.setContactEntFinanHl(contact.getContactEntFinanHl());
                }
                if (contact.getContactStatusHl() != null) {
                    existingContact.setContactStatusHl(contact.getContactStatusHl());
                }
                if (contact.getInternationalContactHl() != null) {
                    existingContact.setInternationalContactHl(contact.getInternationalContactHl());
                }
                if (contact.getContactMediaComuncHl() != null) {
                    existingContact.setContactMediaComuncHl(contact.getContactMediaComuncHl());
                }
                if (contact.getContactOrgCommunityHl() != null) {
                    existingContact.setContactOrgCommunityHl(contact.getContactOrgCommunityHl());
                }
                if (contact.getContactRegulatoryOrganismsHl() != null) {
                    existingContact.setContactRegulatoryOrganismsHl(contact.getContactRegulatoryOrganismsHl());
                }
                if (contact.getContactProveedoresHl() != null) {
                    existingContact.setContactProveedoresHl(contact.getContactProveedoresHl());
                }
                if (contact.getContactSocialNetworks() != null) {
                    existingContact.setContactSocialNetworks(contact.getContactSocialNetworks());
                }
                if (contact.getContactShareholdersHl() != null) {
                    existingContact.setContactShareholdersHl(contact.getContactShareholdersHl());
                }
     ...
     */
    @GetMapping("/contacts")
    public List<Contact> getAllContacts(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
