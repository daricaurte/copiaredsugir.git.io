...
describe('Relation Management Delete Component', () => {
  let comp: RelationDeleteDialogComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [RelationDeleteDialogComponent],
      providers: [NgbActiveModal],
    })
      .overrideTemplate(RelationDeleteDialogComponent, '')
      .compileComponents();
