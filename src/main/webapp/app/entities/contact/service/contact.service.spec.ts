...
describe('Contact Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      id: 0,
      contact3rdSectorHl: false,
      contactAcademyHl: false,
      contactTeethHl: false,
      contactEmployeeHl: false,
      contactEntFinanHl: false,
      contactStatusHl: false,
      internationalContactHl: false,
      contactMediaComuncHl: false,
      contactOrgCommunityHl: false,
      contactRegulatoryOrganismsHl: false,
      contactProveedoresHl: false,
      contactSocialNetworks: false,
      contactShareholdersHl: false,
    };
  });
  ...
  describe('Service methods', () => {
    ...
    it('should update a Contact', () => {
      const returnedFromService = Object.assign(
        {
          id: 1,
          contact3rdSectorHl: true,
          contactAcademyHl: true,
          contactTeethHl: true,
          contactEmployeeHl: true,
          contactEntFinanHl: true,
          contactStatusHl: true,
          internationalContactHl: true,
          contactMediaComuncHl: true,
          contactOrgCommunityHl: true,
          contactRegulatoryOrganismsHl: true,
          contactProveedoresHl: true,
          contactSocialNetworks: true,
          contactShareholdersHl: true,
        },
        elemDefault
      );
